...
$trigger$
    ...
    BEGIN
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, rank)
                             VALUES (NEW.id, 'External Executive Vice President', TRUE, presidentRoleID, 20)
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, rank)
                             VALUES (NEW.id, 'Internal Executive Vice President', TRUE, presidentRoleID, 30)
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, rank)
                             VALUES (NEW.id, 'Vice President of Documentations', TRUE, executiveSecretariatRoleID, 40)
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, rank)
                             VALUES (NEW.id, 'Associate Vice President of Documentations', FALSE, vpdRoleID, 50)
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, home_url, rank)
                             VALUES (NEW.id, 'Vice President of Finance', TRUE, ievpRoleID, '/Organization/treasurer/dashboard', 60)
        ...
        INSERT INTO OrganizationRole(organization, name, uniquePosition, masterRole, home_url, rank)
                             VALUES (NEW.id, 'Associate Vice President of Finance', FALSE, vpfRoleID, '/Organization/treasurer/dashboard', 70)
