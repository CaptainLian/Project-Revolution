<script>
    ...
    $("#reject").click(function(){
        ...
        swal({   
            ...
            console.log(data);
            console.log("REJECT");
            $('#doc').removeClass("bounceInLeft animated").addClass("bounceInLeft   animated").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
