...
module.exports = function(configuration, modules, models, database, queryFiles) {
    ...
    */
    ...
    CSOController.viewExecHome = (req, res) => {
        ...
        database.task(task => {
            ...
            return database.task(task => {
                return task.batch([
                    ...
                    Promise.resolve(uncheckedGOSM),
                    Promise.resolve(ApprovedGOSM),
                    Promise.resolve(PendedGOSM),
            ...
            let uncheckedGOSM = homeData.shift();
            let ApprovedGOSM = homeData.shift();
            let PendedGOSM = homeData.shift();
            ...
            let uncheckedGOSM = organizationDatas.shift();
            let ApprovedGOSM = organizationDatas.shift();
            let PendedGOSM = organizationDatas.shift();
        ...
        }).then(([organizations, gosm, uncheckedGOSM, ApprovedGOSM, PendedGOSM, totalGrade]) => {
            let renderData = Object.create(null);
